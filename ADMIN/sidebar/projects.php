    ...
    <main class="main-content projects-content">
        <div class="page-stack">
            ...
            >
                ...
                <?php if ($isTrashView): ?>
                    <section class="page-stack archive-section is-active" data-archive-section="projects" style="margin-top: 24px;">
                    ...
                    <section class="page-stack archive-section" data-archive-section="users" style="margin-top: 24px;">
                    ...
                    <section class="page-stack archive-section" data-archive-section="purchase_requests" style="margin-top: 24px;">
                    ...
                    <section class="page-stack archive-section" data-archive-section="suppliers" style="margin-top: 24px;">
                    ...
                    <section class="page-stack archive-section" data-archive-section="assets" style="margin-top: 24px;">
