...
if (!defined('ADMIN_RENDER_USER_MANAGEMENT_PARTIAL')) {
    $_GET['tab'] = isset($_GET['create']) ? 'create' : 'users';
    require __DIR__ . '/../dashboards/admin_dashboard.php';
    return;
}
    ...
    <section class="user-management-shell" data-user-management-shell data-create-modal-default-open="<?php echo $userWorkspaceShouldOpenModal ? 'true' : 'false'; ?>">
        <section class="dashboard-panel user-management-panel">
            ...
            <div class="dashboard-actions user-filters">
                <a href="/codesamplecaps/ADMIN/sidebar/user_management.php" class="action-chip<?php echo $userStatusFilter === '' ? ' active-chip' : ''; ?>">All Users</a>
                <a href="/codesamplecaps/ADMIN/sidebar/user_management.php?status=active" class="action-chip<?php echo $userStatusFilter === 'active' ? ' active-chip' : ''; ?>">Active</a>
                <a href="/codesamplecaps/ADMIN/sidebar/user_management.php?status=inactive" class="action-chip<?php echo $userStatusFilter === 'inactive' ? ' active-chip' : ''; ?>">Inactive</a>
            </div>
