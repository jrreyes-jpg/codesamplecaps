...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        audit_log_event($conn, $userId, 'stock_out', 'inventory', $inventoryId, ['quantity' => $previousQuantity], ['quantity' => $newQuantity, 'removed' => $quantity]);

        $conn->commit();
        inventory_clerk_set_flash('success', 'Stock out saved successfully.');
