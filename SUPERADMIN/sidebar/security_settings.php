...
<head>
    ...
    <title>Security Settings - Super Admin</title>
    ...
    <main class="main-content">
        <section class="dashboard-panel">
            <div class="panel-heading">
                <div>
                    <h1 class="dashboard-section-title">Security Settings</h1>
                    <p class="panel-copy">Place login lockout, password policy, and account security controls here.</p>
                </div>
            </div>
        </section>
    </main>
